<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="px-4 mx-auto max-w-8xl sm:px-6 lg:px-8 hedbar">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="w-8 h-8 cursor-pointer cacher">
                    <svg class="w-full fill-black" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
