    ...
    <div class="font-[sans-serif]">
        <div class="p-4 mx-auto lg:max-w-8xl sm:max-w-full">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="mb-8 text-xl font-extrabold text-gray-800">Listes des trajets</h2>
                </div>
                <div>
                    <a href=" {{ route('trajets.create') }} " class="p-2 text-white bg-green-700 rounded-md hover:bg-green-900">Créer un trajet</a>
                </div>
            </div>
            {{-- <h2 class="mb-6 text-2xl font-extrabold text-gray-800">Nouveaux trajets</h2> --}}
                    ...
                    @forelse ($trajets as $trajet)
                        <div class="relative overflow-hidden transition-all rounded shadow-md cursor-pointer bg-gray-50 hover:-translate-y-2">
                            ...
                            <div class="p-6 bg-white">
                                <div class="flex justify-between px-4 py-2 mb-4 bg-black rounded-xl">
                                    <h3 class="text-lg font-extrabold text-gray-800">
                                        <h3 class="italic text-white">Départ : </h3>
                                        <p class="font-bold text-yellow-400"> {{ $trajet->lieuDepart}} </p>
                                    </h3>

                                    <h3 class="text-lg font-extrabold text-gray-800">
                                        <h3 class="italic text-white">Arrivé : </h3>
                                        <p class="font-bold text-yellow-400">{{ $trajet->lieuArrive}}</p>
                                    </h3>
                                ...
                                <div class="flex items-center justify-between">
                                    <h4 class="mt-2 text-lg font-bold text-gray-800">Prix trajet principal :</h4>
                                    <h4 class="mt-2 text-xl font-bold text-green-900">{{ $trajet->tarif}}f</h4>
                                </div>

                                <div class="flex items-center justify-between">
                                    <h4 class="mt-2 text-lg font-bold text-gray-800">Nombre de place disponible:</h4>
                                    <h4 class="mt-2 text-xl font-bold text-green-900">{{ $trajet->nombrePlaceDisponible}}</h4>
                                </div>
                                ...
                                <div class="flex gap-8 mt-3 items-center">
                                    <div>
                                        <a href=" {{ route('trajets.edit', $trajet->id) }} " class="text-indigo-600 hover:text-indigo-900">
                                    ...
                                    <div>
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <a href=" {{ route('trajets.show', $trajet->id) }} " class="text-indigo-600 hover:text-indigo-900">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 text-gray-950 cursor-pointer">
