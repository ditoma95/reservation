    ...
    <div class="font-[sans-serif]">
        <div class="p-4 mx-auto lg:max-w-8xl sm:max-w-full">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <a href=" {{ route('trajets.create') }} " class="bg-green-700 p-2 rounded-md hover:bg-green-900 text-white">Créer un trajet</a>
                </div>
            </div>
            {{-- <h2 class="text-2xl font-extrabold text-gray-800 mb-6">Nouveaux trajets</h2> --}}
