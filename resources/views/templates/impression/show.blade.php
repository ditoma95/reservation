<x-app-layout>
    <div class="flex items-center justify-between mt-8 mb-6">
        <h1 class="text-2xl font-bold">Afficher une impression</h1>
         <div class="">
                    ...
                    <form  method="get">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="grid col-span-6 sm:col-span-3">
                                ...
                                <input required type="text" name="avisService" placeholder="Avis du service"  value="@php if (!empty($impression)){echo $impression->avisService;} @endphp"  disabled>
                            </div>

                            <div class="grid col-span-6 sm:col-span-3">
                                <label for="commentaire" class="text-black">Commentaire</label>
                                <input required type="text" name="commentaire" placeholder="commentaire" value="@php if (!empty($impression)){echo $impression->commentaire;} @endphp"  disabled >
                            </div>

                            <div class="grid col-span-6 sm:col-span-3">
                                <label for="dateAvis" class="text-black">Date d'avis</label>
                                <input required type="date" name="dateAvis" value="@php if (!empty($impression)){echo $impression->dateAvis;} @endphp"  disabled>
                            </div>
                        </div>
