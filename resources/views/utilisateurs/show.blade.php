...
@section('dimitri')
    <div class="flex justify-end mb-4">
        <a class="p-2 text-white bg-green-800 rounded-lg cursor-pointer hover:bg-green-600 " href="{{ route('index') }}"> liste des trajets</a>
    </div>
          ...
          <div class="flex flex-wrap mx-auto rounded-lg lg:w-4/5 bg-slate-800">
            ...
            <div class="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
              <div class="flex items-center gap-6">
                <h1 class="mb-1 text-3xl font-medium text-gray-100 title-font">Dp : {{ $trajet->lieuDepart}}</h1>
                <h1 class="mb-1 text-3xl font-medium text-gray-100 title-font">Ar : {{ $trajet->lieuArrive}}</h1>
              </div>
              <div class="flex mb-4">
              ...
              <div class="flex items-center gap-3">
                <span class="text-2xl font-medium text-gray-100 title-font">{{ $trajet->tarif}}F</span>

                <div class="flex items-center gap-2">
                  <div>
                    <a href="{{ route('tefo', [$trajet->tarif, $trajet->id]) }}">Tmoney</a>
                  </div>                 
                </div>
