                      ...
                      <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                          <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                              ...
                              <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                    ...
                                    @forelse ($roles as $role)
                                        <tr>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                <div>
                                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $role->id }}</h2>
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <a href="{{ url('roles/' . $role->id . '/give-permissions') }}" class="text-indigo-600 hover:text-indigo-900">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-blue-700 cursor-pointer">
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <a href="{{ url('roles/' . $role->id . '/edit') }}" class="text-indigo-600 hover:text-indigo-900">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="px-6 py-4 text-sm font-medium text-center text-gray-500 whitespace-nowrap">Aucun rôle disponible</td>
                                        </tr>
                                    @endforelse
