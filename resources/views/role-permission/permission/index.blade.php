                                ...
                                @forelse ($permissions as $permission)
                                        <tr>
                                            <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                <div>
                                                    <h2 class="font-medium text-gray-800 dark:text-white ">{{ $permission->id }}</h2>
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <a href="{{ url('permissions/' . $permission->id . '/edit') }}" class="text-indigo-600 hover:text-indigo-900">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="px-6 py-4 text-sm font-medium text-center text-gray-500 whitespace-nowrap">Aucune permission disponible</td>
                                        </tr>
                                    @endforelse
