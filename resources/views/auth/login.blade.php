<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <h1 class="mb-6 text-2xl italic font-bold text-center text-white">Connexion</h1>
            ...
            <div class="flex items-center justify-between gap-2 mt-6">
                <div>
                    <a href="jajvascript:void(0);" class="text-sm font-semibold text-white">
                      Forgot Password?
                    </a>
                </div>
            ...
            <div class="flex items-center justify-between gap-2 mt-6">
                <div>
                    <a href="jajvascript:void(0);" class="text-sm font-semibold text-white ">
                      Don't have an acoupt?
                    </a>
                </div>
                
                <div class="flex items-center">
                    <a href="{{ route('register') }}" class="text-sm text-white">
                        {{ __('Register') }}
                    </a>
                </div>
